	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SynopsysV1().Hubs(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SynopsysV1().Hubs(namespace).Watch(options)
			},
		},
		&hubv1.Hub{},
		resyncPeriod,
...
func (f *hubInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hubv1.Hub{}, f.defaultInformer)
}

func (f *hubInformer) Lister() v1.HubLister {
	return v1.NewHubLister(f.Informer().GetIndexer())
}
