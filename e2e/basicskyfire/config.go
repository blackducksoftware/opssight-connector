...
// Config contains all configuration for Mirage
type Config struct {
	...
	// Namespace where all the pods to be created
	Namespace   string
	SkyfireHost string // Should be passed like: e.g. "skyfire"
	SkyfirePort string // Should be passed like: e.g. "3005"
	NoOfPods    int
...
// StartWatch will start watching the Mirage configuration file and
